...
const WA = "https://wa.me/5511987654321?text=Ol%C3%A1%2C%20Bruna!%20Gostaria%20de%20falar%20sobre%20per%C3%ADcia%20trabalhista.";
...
export default function Hero() {
  return (
    <section id="inicio" className="relative overflow-hidden bg-ink-900 pt-16 text-white md:pt-[70px]">
