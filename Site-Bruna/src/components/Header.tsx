...
import { IconCalendar, Monogram } from "./Icons";
...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="container-x flex h-16 items-center justify-between md:h-[70px]">
        <a href="#inicio" className="group flex items-center gap-3" aria-label="Bruna Andrade — início">
          <Monogram className="h-8 w-8 text-gold-400 transition-transform duration-500 group-hover:scale-105 md:h-9 md:w-9" />
          <span className="leading-none">
            <span className="block font-display text-[17px] tracking-[0.08em] text-white md:text-[19px]">
              BRUNA ANDRADE
            </span>
