    ...
    <section className="border-t border-line bg-cream-100 py-20 md:py-24">
      <div className="container-x grid gap-10 lg:grid-cols-12">
        <Reveal className="min-w-0 lg:col-span-4">
          ...
          <h2 className="mt-4 font-display text-[28px] font-medium leading-[1.2] text-inktext sm:text-[32px] md:text-[36px]">
            A confiança de quem já trabalhou comigo.
          </h2>
        </Reveal>

        <Reveal delay={120} className="min-w-0 w-full lg:col-span-8">
          <div className="flex items-start justify-between gap-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-gold-500/50 text-gold-600 transition-all duration-300 hover:-translate-y-0.5 hover:bg-gold-500 hover:text-white active:scale-95"
              >
          ...
          >
            ...
            >
              {ITEMS.map((t) => (
                <figure key={t.name} className="w-full shrink-0 basis-full min-w-0 pr-2">
                  <blockquote className="font-display text-[16px] italic leading-[1.75] text-inktext sm:text-[18px] md:text-[20px] break-words">
                    “{t.quote}”
                  </blockquote>
